...
function New-TestFormalHeaderRecord {
    ...
    $formal = [ordered]@{
        ...
        master_template = [ordered]@{ asset_id = 'NOTE-HEADER-MASTER-v1.0'; version = 'v1.0'; canonical_locator = '04_AI_Work_Environment/Visual_Production/assets/NOTE_HEADER_MASTER_TEMPLATE_v1.0.png'; expected_sha256 = $masterSha; actual_sha256 = $masterSha; width = 1280; height = 670; provenance = 'repository-master-manifest:test' }
